...
const catalogHeaderButton = document.querySelector('.catalog-header__button')
...
if (catalogHeaderButton) {
	...
	catalogHeaderButton.addEventListener('click', function() {
		slideToggle(catalogBody)
		catalogBody.classList.toggle('active')
	})
	window.addEventListener('click', function(e) {
		if (
			catalogBody.classList.contains('active')
			&& !e.target.closest('.catalog-header__button')
			&& !e.target.closest('.catalog-header__body')
		) {
			slideUp(catalogBody)
...
window.addEventListener('scroll', function() {
	if (document.documentElement.scrollTop > header.offsetHeight && !header.classList.contains('scroll')) {
...
const priceSlider = document.querySelector('.price-filter-catalog__slider')
if (priceSlider) {
	const minValue = priceSlider.dataset.minValue
	const maxValue = priceSlider.dataset.maxValue
	const minValueElement = document.querySelector('.price-filter-catalog__min-value')
	const maxValueElement = document.querySelector('.price-filter-catalog__max-value')
...
const searchButton = document.querySelector('.top-header__search')
...
if (searchButton) {
	...
	searchButton.addEventListener('click', function(e) {
		...
		if (e.target.closest('.top-header__search') && iconMenu && iconMenu.classList.contains('active')) {
			toggleMenu()
		}
		...
		if (searchForm.classList.contains('active')) {
			...
			searchForm.style.top = 'calc(100% + 15px)'
			setTimeout(() => {
	...
	window.addEventListener('click', function(e) {
		if (searchForm.classList.contains('active') && !e.target.closest('.search-header')) {
...
if (filterBody) {
	const filterButton = document.querySelector('.actions-products__filter-button')

	if (window.innerWidth < 991 && !filterBody.hasAttribute('hidden')) {
		filterBody.setAttribute('hidden', '')
	}
	window.addEventListener('resize', function() {
		if (window.innerWidth < 991 && !filterBody.hasAttribute('hidden')) {
			filterBody.setAttribute('hidden', '')
		} else if (window.innerWidth > 991 && filterBody.hasAttribute('hidden')) {
	...
	window.addEventListener('click', function(e) {
		if (window.innerWidth < 991) {
			if (!e.target.closest('.filter-catalog__body') && !filterBody.hasAttribute('hidden')) {
				slideUp(filterBody)
			}
		}
	})
	...
	filterButton.addEventListener('click', function() {
		slideToggle(filterBody)
	})
}


const tabLinks = document.querySelectorAll(".tabs__item");
const tabContent = document.querySelectorAll(".content-tabs__item");
...
let mainslider, popularProductsSlider, productSlider,
	imagesProductSubslider, imagesProductMainSlider,
	similarProductsSlider

function initSliders() {
	if (!document.querySelector('.mainslider__body.swiper-container-initialized')) {
	...
	if (!document.querySelector('.slider-products-page_popular .slider-products-page__body.swiper-container-initialized')) {
		popularProductsSlider = new Swiper('.slider-products-page_popular .slider-products-page__body', {
			slidesPerView: 3,
			clickable: true,
			spaceBetween: 20,
			speed: 700,
			...
			navigation: {
				nextEl: ".slider-products-page_popular .slider-products-page__button-next",
				prevEl: ".slider-products-page_popular .slider-products-page__button-prev",
			},
		})
	}
	if (!document.querySelector('.slider-products-page_similar .slider-products-page__body.swiper-container-initialized')) {
		similarProductsSlider = new Swiper('.slider-products-page_similar .slider-products-page__body', {
			slidesPerView: 3,
			clickable: true,
			spaceBetween: 20,
			speed: 700,
			...
			navigation: {
				nextEl: ".slider-products-page_similar .slider-products-page__button-next",
				prevEl: ".slider-products-page_similar .slider-products-page__button-prev",
			},
		})
	}
}
...
function initProductSliders() {
	if (!document.querySelector('.images-product__subslider.swiper-container-initialized')) {
		imagesProductSubslider = new Swiper(".images-product__subslider", {
			spaceBetween: 5,
			watchOverflow: true,
			slidesPerView: 5,
			direction: 'vertical',
	...
	if (!document.querySelector('.images-product__mainslider.swiper-container-initialized')) {
		imagesProductMainSlider = new Swiper(".images-product__mainslider", {
			spaceBetween: 10,
			navigation: {
...
function activateOrDeactivateSlider() {
	if (window.innerWidth > 767) {
		...
		if (mainslider && document.querySelector('.mainslider__body.swiper-container-initialized')) {
			mainslider.destroy();
		}
		if (popularProductsSlider && document.querySelector('.slider-products-page_popular .slider-products-page__body.swiper-container-initialized')) {
			popularProductsSlider.destroy();
		}
		if (similarProductsSlider && document.querySelector('.slider-products-page_similar .slider-products-page__body.swiper-container-initialized')) {
			similarProductsSlider.destroy();
		}
	...
	if (window.innerWidth > 992) {
		...
		if (imagesProductSubslider && document.querySelector('.images-product__subslider.swiper-container-initialized')) {
			imagesProductSubslider.destroy();
		}
		if (imagesProductMainSlider && document.querySelector('.images-product__mainslider.swiper-container-initialized')) {
			imagesProductMainSlider.destroy();
		}
	}
...
const productsSlider = new Swiper('.products-slider__body', {
	slidesPerView: 1,
	clickable: true,
	autoHeight: true,
	spaceBetween: 20,
...
const firstProductsPageSlider = new Swiper('.slider-products-page_first .slider-products-page__body', {
	slidesPerView: 1.4,
	clickable: true,
	spaceBetween: 20,
	speed: 700,
	...
	navigation: {
		nextEl: ".slider-products-page_first .slider-products-page__button-next",
		prevEl: ".slider-products-page_first .slider-products-page__button-prev",
	},
})

const secondProductsPageSlider = new Swiper('.slider-products-page_second .slider-products-page__body', {
	slidesPerView: 1.4,
	clickable: true,
	spaceBetween: 20,
	speed: 700,
	...
	navigation: {
		nextEl: ".slider-products-page_second .slider-products-page__button-next",
		prevEl: ".slider-products-page_second .slider-products-page__button-prev",
	},
})

const thirdProductsPageSlider = new Swiper('.slider-products-page_third .slider-products-page__body', {
	slidesPerView: 1.4,
	clickable: true,
	spaceBetween: 20,
	speed: 700,
	...
	navigation: {
		nextEl: ".slider-products-page_third .slider-products-page__button-next",
		prevEl: ".slider-products-page_third .slider-products-page__button-prev",
	},
})



const fourthProductsPageSlider = new Swiper('.slider-products-page_fourth .slider-products-page__body', {
	slidesPerView: 1.4,
	clickable: true,
	spaceBetween: 20,
	speed: 700,
	...
	navigation: {
		nextEl: ".slider-products-page_fourth .slider-products-page__button-next",
		prevEl: ".slider-products-page_fourth .slider-products-page__button-prev",
	},
})
